...
public struct NettyError: Error {
    public let type: ErrorType
    public let details: NettyErrorDetails?
    public let data: Data?
    
    public init(type: ErrorType, details: NettyErrorDetails? = nil, data: Data? = nil) {
        self.type = type
...
public struct NettyErrorDetails {
